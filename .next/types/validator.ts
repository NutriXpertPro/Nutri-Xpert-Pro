...
// Validate ../../pages/anamnesis/[id].tsx
{
  const handler = {} as typeof import("../../pages/anamnesis/[id].js")
  handler satisfies PagesPageConfig
}

// Validate ../../pages/dashbord/index.tsx
{
  const handler = {} as typeof import("../../pages/dashbord/index.js")
  handler satisfies PagesPageConfig
}
