...
export default function PatientLogin() {
  ...
  const handleFacebookLogin = () => {
    signIn("facebook", { callbackUrl: "/patient/dashboard" });
  };
      ...
      <div style={{
        ...
        onMouseLeave={(e) => {
          ...
          <h1 style={{
            ...
            textAlign: 'center',
            marginBottom: '35px',
            background: 'linear-gradient(135deg, #ffffff, #10b981, #84cc16)',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
            ...
            <button
              ...
              onMouseOver={(e) => {
                e.currentTarget.style.transform = 'translateY(-5px) scale(1.03)';
                e.currentTarget.style.boxShadow = '0 20px 40px rgba(24, 119, 242, 0.5)';
              }}
              onMouseOut={(e) => {
                e.currentTarget.style.transform = 'translateY(0) scale(1)';
